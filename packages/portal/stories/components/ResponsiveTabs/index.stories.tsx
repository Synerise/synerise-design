...
import ResponsiveTabs from '@synerise/ds-responsive-tabs';
...
storiesOf('Components|Responsive Tabs', module)
    ...
    return (
      <DSProvider code="en_GB">
        <div style={{width: '600px', maxWidth: '100%', padding: '24px', background: '#fff'}}>
          <ResponsiveTabs tabs={tabs} activeTab={store.state.activeTab} handleTabClick={(index: number) => store.set({activeTab: index})} />
        </div>
      </DSProvider>
    );
  }))

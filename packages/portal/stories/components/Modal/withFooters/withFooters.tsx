...
import ModalProxy, { buildModalFooter } from "@synerise/ds-modal";
    ...
    case FooterTypes.DEFAULT_WITH_SWITCH:
      return {
        ...
        footer: buildModalFooter({
          ...propsWithKnobs() as any,
          ...mockModalProps,
          prefix: <div style={{ width: '100%', display: 'flex', alignItems: 'center' }}>
            <Switch onChange={setSwitchEnabled} label={text('Set switch label', 'Show property')}

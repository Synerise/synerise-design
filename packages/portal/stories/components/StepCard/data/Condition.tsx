...
export const ConditionExample = React.forwardRef<HTMLDivElement, ConditionExampleProps>(
  (
    ...
    const setActionAttribute = useCallback(
      (stepId, value) => {
        onChange(
          steps.map(step => {
            if (step.id === stepId) {
    ...
    return (
      <div ref={ref}>
        <Condition
          ...
          removeStep={!singleStepCondition && boolean('Show remove step', false) ? removeStep : undefined}
          duplicateStep={!singleStepCondition && boolean('Show duplicate step', false) ? duplicateStep : undefined}
          addStep={!singleStepCondition && boolean('Enable default add step', false) ? addStep : undefined}
          renderAddStep={
            !singleStepCondition && boolean('Enable custom add step', false) ? renderCustomAddStep : undefined
          }
          onChangeOrder={!singleStepCondition && boolean('Enable change order', true) && onChangeOrder}
          ...
          onChangeActionAttribute={setActionAttribute}
          showSuffix={boolean('Display and suffix', true)}
          hoverDisabled={hoverDisabled}
          readOnly={readOnly}
          singleStepCondition={singleStepCondition}
          showActionAttribute={boolean('Show action attribute field', true)}

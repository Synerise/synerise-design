...
import { STYLE_ARG_CONTROL, CLASSNAME_ARG_CONTROL, stringWithNoControl, PREFIXCLS_ARG_CONTROL, STRING_CONTROL, BOOLEAN_CONTROL, REACT_NODE_AS_STRING, NUMBER_CONTROL, controlFromOptionsArray, tableConfig } from '../../utils';
...
const callbackControl = { 
  ...
  export const relativeArgTypes: Partial<ArgTypes<typeof DateRangePicker>> = {
    ...
    relativePast: { // What does this do?
        ...tableConfig({category: 'Relative Picker configuration'}),
        ...BOOLEAN_CONTROL
    },
    relativeFuture: { // What does this do?
        ...tableConfig({category: 'Relative Picker configuration'}),
        ...BOOLEAN_CONTROL
    },
}

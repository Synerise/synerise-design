...
type StoryProps = ItemUploaderProps & {
...
export default {
  ...FileUploaderMeta,
  title: 'Components/FileUploader/ItemUploader',
...
export const ItemUploaderStory: Story = {
  name: 'ItemUploader',
};

export const ItemUploaderMultiple: Story = {
  args: {
    mode: 'multi',
  },
};

...
export const RelativeHeightSmall: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(() =>
      expect(dropdown1.getAllByRole('menuitem')).toHaveLength(5),
    );
  },
};
export const RelativeHeightMedium: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const dropdown1 = within(canvas.getByTestId('ds-item-picker-dropdown'));
    await waitFor(() =>
      expect(dropdown1.getAllByRole('menuitem')).toHaveLength(10),
    );
  },
};
export const RelativeHeightLarge: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const dropdown1 = within(canvas.getByTestId('ds-item-picker-dropdown'));
    await waitFor(() =>
      expect(dropdown1.getAllByRole('menuitem')).toHaveLength(16),
    );
  },
};

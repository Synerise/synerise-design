...
import { FLAT_DATA_SOURCE } from './ItemPicker.data';

import ItemPickerMeta, { Default } from './ItemPicker.stories';

export default {
  ...ItemPickerMeta,
  title: 'Components/Pickers/ItemPicker/Tests',
  tags: ['visualtests'],
...
const runOpenDropdown = async (canvas, args) => {
  ...
  await waitFor(() => canvas.getByPlaceholderText(args.searchPlaceholder!));

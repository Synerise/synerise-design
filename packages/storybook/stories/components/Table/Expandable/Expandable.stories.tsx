...
export default {
  ...
  render: ({
    ...
    const columns = renderWithIconInHeaders<RowTypeDefault>(
      columnsData,
      showIconsInHeader,
    );
...
export const WithContainer: Story<RowTypeWithContainer> = {
  render: ({
    ...
    const columnsData: (DSColumnType<RowTypeWithContainer> &
    ...
    const columns = renderWithIconInHeaders<RowTypeWithContainer>(
      columnsData,
      showIconsInHeader,
    );
    const headerButton = showHeaderButton && (

...
import OrderedList from '../Ordered-list';
  ...
  describe('Ordered-list with nested items', () => {
    ...
    it('should render basic menu list', () => {
      // ARRANGE
      const { getByText } = renderWithProvider(<OrderedList indexFormatter={indexFormatter} data={data as unknown as OrderedListItem[]}/>);
...
describe('Ordered-list indexFormatter', () => {
  ...
  it('should render basic menu list', () => {
    // ARRANGE
    const { getByText } = renderWithProvider(<OrderedList data={data as unknown as OrderedListItem[]}  indexFormatter={customIndexFormatter}/>);

...
const ParameterInput: React.FC<InputProps> = ({ value, onChange, parameters }) => {
  ...
  return (
    <Dropdown
      ...
      overlay={
        <ParameterDropdown setDropdownVisible={setDropdownVisible} setSelected={handleChange} {...restParameters} />
      }
    >

...
describe('FormattedDate TimezoneTesting', () => {
  it.each(TIMEZONE_DATA)(
    ...
    ({ timeZone, EUDate }) => {
      renderWithProvider(<FormattedDate value={TZ_DATE_TO_FORMAT} />, {}, { timeZone });
  ...
  it.each(TIMEZONE_DATA)('should render properly date with EU notation in TZ $timeZone', ({ timeZone, EUDate }) => {
    renderWithProvider(<FormattedDate value={TZ_DATE_TO_FORMAT} />, {}, { timeZone, notation: EU_NOTATION });
    expect(screen.getByText(EUDate)).toBeTruthy();
  });
  ...
  it.each(TIMEZONE_DATA)(
    ...
    ({ timeZone, USDate }) => {
      renderWithProvider(<FormattedDate value={TZ_DATE_TO_FORMAT} />, {}, { timeZone, notation: US_NOTATION });

...
describe('FormattedTime TimezoneTesting', () => {
  it.each(TIMEZONE_DATA)(
    ...
    ({ timeZone, EUTime }) => {
      renderWithProvider(<FormattedTime value={TZ_DATE_TO_FORMAT} />, {}, { timeZone });
  ...
  it.each(TIMEZONE_DATA)('should render properly date with EU notation in TZ $timeZone', ({ timeZone, EUTime }) => {
    renderWithProvider(<FormattedTime value={TZ_DATE_TO_FORMAT} />, {}, { timeZone, notation: EU_NOTATION });
    expect(screen.getByText(EUTime)).toBeTruthy();
  });
  ...
  it.each(TIMEZONE_DATA)(
    ...
    ({ timeZone, USTime }) => {
      renderWithProvider(<FormattedTime value={TZ_DATE_TO_FORMAT} />, {}, { timeZone, notation: US_NOTATION });

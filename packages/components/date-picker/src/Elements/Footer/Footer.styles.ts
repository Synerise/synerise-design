...
export const LinkButton = styled.button`
  ...
  padding: 0;
  border: none;
  color: ${props => props.theme.variable('@link-color')};
  ...
  &:hover {
    color: ${props => props.theme.variable('@link-hover-color')};
  }

  &:active {
    color: ${props => props.theme.variable('@link-active-color')};
  }
  ...
  &[disabled] {
    color: ${props => props.theme.variable('@disabled-color')};
    cursor: not-allowed;
    pointer-events: none;
  }
`;

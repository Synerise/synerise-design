...
export const PickerWrapper = styled.div<{
  ...
  .ant-popover.ds-date-range-popover.ant-popover-placement-bottomLeft > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.bottomLeft}-050`] : props.theme.palette.white};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-bottomRight > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.bottomRight}-050`] : props.theme.palette.white};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-rightTop > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.rightTop}-050`] : props.theme.palette.white};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-rightBottom > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.rightBottom}-050`] : props.theme.palette.white};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-leftBottom > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.leftBottom}-050`] : props.theme.palette.white};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-leftTop > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.leftTop}-050`] : props.theme.palette.white};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-topRight > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.topRight}-050`] : props.theme.palette['grey-050']};
    border-style: none;
    border-width: 0;
  }
  .ant-popover.ds-date-range-popover.ant-popover-placement-topLeft > .ant-popover-content > .ant-popover-arrow {
    background-color: ${(props): string =>
      props.arrowColor ? props.theme.palette[`${props.arrowColor?.topLeft}-050`] : props.theme.palette['grey-050']};
    border-style: none;
    border-width: 0;
  }
`;

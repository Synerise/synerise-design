...
export const useDefaultTexts = (
  ...
  const allTexts = useMemo(
    () => ({
      basicSearchPlaceholder: intl.formatMessage({
      ...
      clearConfirmTitle: intl.formatMessage({
        id: 'DS.ITEM-PICKER.CLEAR-CONFIRM',
        defaultMessage: 'Please confirm',
      }),
      changeButtonLabel: intl.formatMessage({
        id: 'DS.ITEM-PICKER.CHANGE-BUTTON',
        defaultMessage: 'Change',
      }),
      refreshButtonLabel: intl.formatMessage({
        id: 'DS.ITEM-PICKER.REFRESH',
        defaultMessage: 'Refresh',
      }),
      noItems: intl.formatMessage({
      ...
      noResultsInSection: intl.formatMessage({
        ...
        defaultMessage:
          'Please check your phrase or try searching in different folders.',
      }),
      ...
      recentsSectionLabel: intl.formatMessage({
        id: 'DS.ITEM-PICKER-DROPDOWN.RECENTS',
        defaultMessage: 'Recent',
      }),
      actionsSectionLabel: intl.formatMessage({
        id: 'DS.ITEM-PICKER-DROPDOWN.ACTIONS',
        defaultMessage: 'Actions',
      }),
      resultsSectionLabel: intl.formatMessage({
        id: 'DS.ITEM-PICKER-DROPDOWN.RESULTS',
        defaultMessage: 'Results',
      }),
      itemsSectionLabel: intl.formatMessage({
        id: 'DS.ITEM-PICKER-DROPDOWN.ITEMS',
      ...
      backTooltip: intl.formatMessage({
        id: 'DS.ITEM-PICKER-DROPDOWN.BACK-TOOLTIP',
        defaultMessage: 'Back',
      }),

...
export const BannerCounter = ({ slides, currentIndex, onDotClick, onPrevClick, onNextClick }: BannerCounterProps) => {
  return (
    <S.BannerCounterWrapper data-testid="banner-counter">
      ...
      {slides.map((slide, index) => (
        <S.BannerCounterDot key={slide.id} active={index === currentIndex} onClick={() => onDotClick(index)} />
      ))}

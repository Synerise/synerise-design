...
/**
 * Factory function for CodeArea mock.
 * Replaces Monaco Editor with a simple textarea.
 * Use directly with vi.mock() to avoid hoisting issues.
 *
 * @example
 * ```typescript
 * import { codeAreaMockFactory } from '@synerise/ds-mocks/CodeArea/vi';
 *
 * vi.mock('@synerise/ds-code-area', codeAreaMockFactory);
 * ```
 */
export const codeAreaMockFactory = () => ({
  default: vi.fn(
    ({
      className,
      value,
      ...
      return (
        <div className={`ds-code-area ${className || ''}`} data-testid={testId}>
...
/**
 * Factory function for minimal CodeArea mock.
 *
 * @example
 * ```typescript
 * vi.mock('@synerise/ds-code-area', codeAreaMinimalMockFactory);
 * ```
 */
export const codeAreaMinimalMockFactory = () => ({
  default: vi.fn(() => null),
});

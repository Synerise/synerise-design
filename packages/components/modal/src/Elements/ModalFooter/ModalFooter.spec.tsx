...
describe('ModalFooter', () => {
  ...
  const DSButtonMock = ({ children, onClick, disabled }: ButtonProps) => (
  ...
  it('renders custom cancel and apply buttons', () => {
    ...
    renderWithProvider(<ModalFooter onCancel={onCancelMock} onOk={onOkMock} texts={customTexts} />);
  ...
  it('renders prefix, infix and suffix elements in the footer', () => {
    ...
    renderWithProvider(
      <ModalFooter onCancel={onCancelMock} onOk={onOkMock} prefix={prefixNode} suffix={suffixNode} infix={infixNode} />
    );
  ...
  it('renders custom DSButton component for cancel and apply buttons', () => {
    const customDSButton = DSButtonMock;

    renderWithProvider(<ModalFooter onCancel={onCancelMock} onOk={onOkMock} DSButton={customDSButton} />);

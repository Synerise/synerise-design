...
| shouldAutoOpenNextField   | Return false to keep the active field where it is after a change, so only the onChange* callback fires | (change: ConditionFieldChange) => boolean                                                | -                     |

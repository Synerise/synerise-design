...
| onChange               | Callback executed when selection changes         | Function(selectedRowKeys: React.ReactText[], selectedRows: T[]): void | -            |  
...
| itemsMenu                     | Component with menu for selected items                                                                                                                                                                      | ReactNode                                       | -                       |         |

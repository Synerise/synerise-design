      ...
      <section className="c-footer-links l-section">
        <div className="c-main-footer__columns">
          <div className="c-main-footer__first-column">
            <img
              className="c-main-nav__logo-image c-dynamic-image"
              alt="Synerise"
              src="https://strapi.synerise.com/uploads/7cce7cae97314cee865f977b9baf13e5.svg"
            />
          ...
          <div className={`c-links-box ${openedLinks ? 'expanded' : ''}`}>
            ...
            <ul className="c-links-box__submenu submenu-group-0">
              <li>
                <a className="c-links-box__lnk" href="/about">
                  About
                </a>
              </li>
              <li>
                <a className="c-links-box__lnk" href="/develop">
                  Develop
                </a>
              </li>
              {/*<li>*/}
              ...
              {/*</li>*/}
              <li>
                <a className="c-links-box__lnk" href="/storybook-static/">
                  Components
                </a>
              </li>
            </ul>
